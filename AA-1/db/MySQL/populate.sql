...
CREATE TABLE usuario (id INT PRIMARY KEY AUTO_INCREMENT, email VARCHAR(128) NOT NULL, nome VARCHAR(256) NOT NULL, senha VARCHAR(128) NOT NULL, is_admin TINYINT(1) NOT NULL);
...
INSERT INTO usuario (email, nome, senha) VALUES ('admin@gmail.com', 'admin', 'admin', 1);